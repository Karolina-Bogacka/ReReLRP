class GridSearchConfig:
    def __init__(self):
        self.params = {
            ...
            "lwf": {"lamb": 10, "T": 2},
            "icarl": {"lamb": 4},
            "rere_lrp": {"features_saved": 40},
            "div_exp": {"features_saved": 40},
            "dmc": {"aux_dataset": "imagenet_32_reduced", "aux_batch_size": 128},
            "il2m": {},
            "eeil": {
                "lamb": [10],
                "T": 2,
            ...
            "bic": {"T": 2, "val_percentage": 0.1, "bias_epochs": 200},
            "lucir": {"lamda_base": [10], "lamda_mr": 1.0, "dist": 0.5, "K": 2},
            "lwm": {"beta": 2, "gamma": 1.0},
            "ewc": {"lamb": [10000]},
            "mas": {"lamb": [400]},
            "path_integral": {
                "lamb": [10],
