...
_MNT_DATA = "/mnt/karolina/ILSVRC/ImageSets/CLS-LOC/"
...
dataset_config = {
    ...
    "emnist": {
        "path": join(_BASE_DATA_PATH, "emnist"),
        "normalize": ((0.1307,), (0.3081,)),
        # Use the next 3 lines to use MNIST with a 3x32x32 input
        # 'extend_channel': 3,
        # 'pad': 2,
    ...
    "fashionmnist": {
        "path": join(_BASE_DATA_PATH, "fashionmnist"),
        # Use the next 3 lines to use MNIST with a 3x32x32 input
        # 'extend_channel': 3,
        # 'pad': 2,
        # 'normalize': ((0.1,), (0.2752,))    # values including padding
    ...
    "imagenet_256": {
        "path": join(_MNT_DATA, "ILSVRC12_256"),
        "resize": None,
        "crop": 224,
        "flip": True,
        "normalize": ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
    ...
    "imagenet_32_reduced": {
        "path": join(_MNT_DATA, "ILSVRC12_32"),
        "resize": None,
        "pad": 4,
        "crop": 32,
        "flip": True,
